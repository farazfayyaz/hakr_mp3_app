...
function Trending() {
  return (
    <section className='lg:h-96 lg:py-72 flex flex-col gap-10 justify-center sm:h-30 sm:py-10'>
        ...
        <div className='lg:h-60 w-1/2 py-5 flex flex-row-reverse items-center justify-around self-center max-md:flex-col max-md:text-center'>

            <h2 className='w-60 max-md:max-w-60'>
              Check Out Trending Artists
            </h2>

            <p className=' w-80 max-md:max-w-50'>
        ...
        <div className='lg:h-60 w-2/3 py-10 flex place-items-center self-center justify-evenly md:flex-row max-sm:flex-col max-sm:gap-2'>
